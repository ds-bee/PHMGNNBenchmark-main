...
def parse_args():
    ...
    parser.add_argument('--data_dir', type=str, default='D:\\实验\\CMAPSS\\CMAPSSDataNASA数据集六\\', help='the directory of the data')
    parser.add_argument('--monitor_acc', type=str, default='RUL', help='the performance score')
    parser.add_argument('--cuda_device', type=str, default='0', help='assign device')
    parser.add_argument('--checkpoint_dir', type=str, default='./checkpoint/prognosis',
